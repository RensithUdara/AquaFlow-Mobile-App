...
class NotificationSettings {
  ...
  bool isQuietHours(DateTime time) {
    ...
    final start = today.add(Duration(hours: quietHoursStart.hour, minutes: quietHoursStart.minute));
    final end = today.add(Duration(hours: quietHoursEnd.hour, minutes: quietHoursEnd.minute));
  ...
  factory NotificationSettings.fromJson(Map<String, dynamic> json) {
    return NotificationSettings(
      ...
      quietHoursStart: ReminderTime.fromJson(json['quietHoursStart'] as Map<String, dynamic>),
      quietHoursEnd: ReminderTime.fromJson(json['quietHoursEnd'] as Map<String, dynamic>),
    );
  }
}