...
class AppColors {
  ...
  static const Color lightBlue =
      Color(0xFF64B5F6); // Secondary actions, highlights
  static const Color deepBlue = Color(0xFF1976D2); // Headers, primary buttons
  static const Color aquaBlue =
      Color(0xFF00BCD4); // Progress indicators, success states
  static const Color navyBlue =
      Color(0xFF0D47A1); // Dark accents, text emphasis

  // Supporting Colors
  static const Color successGreen =
      Color(0xFF4CAF50); // Goal completed, positive feedback
  static const Color warningOrange =
      Color(0xFFFF9800); // Reminders, attention needed
  static const Color errorRed =
      Color(0xFFF44336); // Validation errors, negative states
  static const Color neutralGray =
      Color(0xFF9E9E9E); // Disabled states, secondary text

  // Light Theme Colors
  static const Color lightBackground =
      Color(0xFFFFFFFF); // Main screen background
  static const Color lightSecondaryBackground =
      Color(0xFFF8F9FA); // Card backgrounds, sections
  static const Color lightSurfaceBackground =
      Color(0xFFF5F5F5); // Input fields, containers
  static const Color lightElevatedSurface =
      Color(0xFFFFFFFF); // Floating cards, modals

  static const Color lightPrimaryText =
      Color(0xFF212121); // Main content, headings
  static const Color lightSecondaryText =
      Color(0xFF757575); // Descriptions, labels
  static const Color lightHintText =
      Color(0xFFBDBDBD); // Placeholders, disabled text
  static const Color lightInverseText =
      Color(0xFFFFFFFF); // Text on colored backgrounds

  static const Color lightProgressFill =
      Color(0xFF00BCD4); // Water level, goal progress
  ...
  static const Color darkBackground =
      Color(0xFF121212); // Main screen background
  static const Color darkSecondaryBackground =
      Color(0xFF1E1E1E); // Card backgrounds, sections
  static const Color darkSurfaceBackground =
      Color(0xFF2C2C2C); // Input fields, containers
  static const Color darkElevatedSurface =
      Color(0xFF383838); // Floating cards, modals

  static const Color darkPrimaryText =
      Color(0xFFFFFFFF); // Main content, headings
  static const Color darkSecondaryText =
      Color(0xFFB3B3B3); // Descriptions, labels
  static const Color darkHintText =
      Color(0xFF666666); // Placeholders, disabled text
  static const Color darkInverseText =
      Color(0xFF121212); // Text on light backgrounds

  static const Color darkProgressFill =
      Color(0xFF26C6DA); // Brighter cyan for dark mode
