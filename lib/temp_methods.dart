  ...
  String? getCurrentStreakAchievement() {
    ...
    if (_userProfile!.longestStreak >= 90) { // Platinum - 90 days
      return 'Platinum';
    } else if (_userProfile!.longestStreak >= 30) { // Gold - 30 days
      return 'Gold';
    } else if (_userProfile!.longestStreak >= 14) { // Silver - 14 days
      return 'Silver';
    } else if (_userProfile!.longestStreak >= 7) { // Bronze - 7 days
      return 'Bronze';
    }
    return null;
  }
